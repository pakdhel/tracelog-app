  ...
  static ThemeData get lightTheme {
    return ThemeData(
      colorScheme: ColorScheme.light(
        ...
        secondaryContainer: TracelogColors.secondaryContainer.color,
        onSecondaryContainer: TracelogColors.onSecondaryContainer.color,
        tertiaryContainer: TracelogColors.tertiaryContainer.color,
        onTertiaryContainer: TracelogColors.onTertiaryContainer.color,
      ),
      useMaterial3: true,
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      colorScheme: ColorScheme.dark(
        ...
        secondaryContainer: TracelogDarkColors.secondaryContainer.color,
        onSecondaryContainer: TracelogDarkColors.onSecondaryContainer.color,
        tertiaryContainer: TracelogDarkColors.tertiaryContainer.color,
        onTertiaryContainer: TracelogDarkColors.onTertiaryContainer.color,
      ),
      useMaterial3: true,
